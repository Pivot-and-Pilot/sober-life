jQuery(document).ready(function($) {
  (function genderQuestion() {
    ...
    $("#loved-one-name").on("change keyup paste", function() {
      ...
      $(".question__client-gender h1").html(
        `What does ${fullName} identify as?`
      );
    });
  ...
  (function customizedText() {
    $("div.client-target").on("click", function() {
      if ($(this).data("value") === "myself") {
        $(".question__drug-effects-life h1").html(
          "How is drug usage affecting your life?"
        );
        $(".insurance-yes-no-wrapper > p").html("Do you have insurance?");
      }
      if ($(this).data("value") === "a loved one") {
        $(".question__drug-effects-life h1").html(
          "How is drug usage affecting their life?"
        );
  ...
  (function getInfo() {
    ...
    $('div[name="client-target"]').on("click", function() {
      ...
      $(`input[name="client-target-hidden"][value="${clientTarget}"]`).prop(
        "checked",
        true
      );
    });
    ...
    $('div[name="client-gender"]').on("click", function() {
      ...
      $(`input[name="client-gender-hidden"][value="${clientGender}"]`).prop(
        "checked",
        true
      );
    });
    ...
    $('div[name="client-feeling"]').on("click", function() {
      ...
      $(`input[name="client-feeling-hidden"][value="${clientFeeling}"]`).prop(
        "checked",
        true
      );
    });
    $('div[name="loved-one-feeling"]').on("click", function() {
      ...
      $(
        `input[name="loved-one-feeling-hidden"][value="${lovedOneFeeling}"]`
      ).prop("checked", true);
    });
    ...
    $('div[name="substances-used"]').on("click", function() {
      ...
      if ($(this).hasClass("choice-chosen")) {
        $(
          `input[data-name="substances-used-hidden"][value="${substancesUsed}"]`
        ).prop("checked", true);
      } else {
        $(
          `input[data-name="substances-used-hidden"][value="${substancesUsed}"]`
    ...
    $('div[name="effect-life"]').on("click", function() {
      ...
      if ($(this).hasClass("choice-chosen")) {
        $(`input[data-name="effect-life-hidden"][value="${effect}"]`).prop(
          "checked",
          true
        );
      } else {
    ...
    $(".insurance-check-box").on("click", function(e) {
      ...
      $(`input[name="insurance-hidden"][value="${answer}"]`).prop(
        "checked",
        true
      );
    });
  ...
  function loadingGreating1() {
    ...
    spacePosition = fullName.indexOf(" ");
    firstName = fullName.slice(0, spacePosition);
    $(".loading-screen > div").html(
      `Hi ${fullName}, tell us more about your situation.`
    );
  }
  ...
  (function navigation() {
      ...
      if (e.keyCode === 13) {
        ...
        setTimeout(function() {
          $(".loading-screen").css({
            opacity: "1",
            "background-image":
              "url('wp-content/themes/sober-life/img/src/hand--green.svg')"
          });
        }, 1000);
    ...
    $("div.client-target").on("click", function() {
      if ($(this).data("value") === "myself") {
        $(".loading-screen > div").html(
          "That's awesome! You're already taking a step in the right direction."
        );
        // loading screen
        setTimeout(function() {
          $(".loading-screen").css({
            opacity: "1",
            "background-image":
              "url('wp-content/themes/sober-life/img/src/sun-symbol--green.svg')"
          });
        }, 1000);
    ...
    $("#loved-one-name").on("change keyup paste", function(e) {
      ...
      if (e.keyCode === 13) {
        ...
        firstName = fullName.slice(0, spacePosition);
        $(".loading-screen > div").html(
          `With the right support ${fullName} will be well equipt to get on the right track`
        );
        setTimeout(function() {
          $(".loading-screen").css({
            opacity: "1",
    ...
    $(".gender-choice").on("click", function() {
      ...
      if (
        $('input[name="client-target-hidden"][value="myself"]').is(":checked")
      ) {
        setTimeout(function() {
      ...
      if (
        $('input[name="client-target-hidden"][value="a loved one"]').is(
          ":checked"
        )
      ) {
        setTimeout(function() {
    ...
    $(".feeling-choice").on("click", function() {
      ...
      if ($(this).data("value") === "hesitant") {
        $(".loading-screen > div").html(
          `We understand your hesitation, ${fullName}. Rest assured, you will have all the necessary resources available to you on this journey.`
        );
      }
      if ($(this).data("value") === "moderate") {
        $(".loading-screen > div").html(
          `No worries, we have every resource available and will answer all the questions you might have`
        );
      }
      if ($(this).data("value") === "i am ready for change") {
        $(".loading-screen > div").html(
          `Amazing! Just a few more questions and we'll get you started on this new chapter of life!`
        );
      }
      setTimeout(function() {
        $(".loading-screen").css({
    ...
    $(".loved-one-feeling-choice").on("click", function() {
      ...
      if ($(this).data("value") === "hesitant") {
        $(".loading-screen > div").html(
          `Hesitation is totally normal. We're here to help ${fullName} discover the different possibilities that change can bring.`
        );
      }
      if ($(this).data("value") === "moderate") {
        $(".loading-screen > div").html(
          `No worries, we have every resource available so that ${fullName} can make an informed decision.`
        );
      }
      if ($(this).data("value") === "it is time for change") {
        $(".loading-screen > div").html(
          `That's great! Just a few more questions and we can get ${fullName} started on this new chapter.`
        );
      }
      if ($(this).data("value") === "dont know") {
        $(".loading-screen > div").html(
          `No worries, just a few more questions and we can talk about starting ${fullName} on the journey to recovery!`
        );
      }
      setTimeout(function() {
        $(".loading-screen").css({
  ...
  (function submit() {
    ...
    $("#form__submit").on("click", function() {
      ...
      if (
        !$('input[name="insurance-hidden"][value="yes"]').is(":checked") &&
        !$('input[name="insurance-hidden"][value="no"]').is(":checked")
      ) {
        $(".check-box").css("border", "3px solid #F31431");
      }
      if (
        ($(".form__phone-number--hidden").val() &&
          $(".form__city--hidden").val() &&
          $(".form__email--hidden").val() &&
          $(".form__state--hidden").val() &&
          $(".form__dob--hidden").val() &&
          $('input[name="insurance-hidden"][value="yes"]').is(":checked")) ||
        $('input[name="insurance-hidden"][value="no"]').is(":checked")
      ) {
