...
function toggleMenu() {
  ...
  if (isOpen) {
    ...
    // document.getElementById('header__menu-overlay-content').style.transition = 'right 0.8s ease-in-out';    
    document.getElementById('header__menu-overlay').style.width = '0%';
    document.getElementById('header__hamburger').classList.remove('open');
    document
    .getElementById('header__menu-nav')
    ...
    // document.getElementById('header__menu-overlay-content').style.transition = 'right 0.3s ease-in-out';    
